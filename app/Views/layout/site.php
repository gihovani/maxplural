...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/newsletter.min.css') ?>?v=<?= $version?>"/>
    <link rel="stylesheet" href="<?= base_url('assets/css/master.css') ?>?v=<?= $version?>"/>
...
<script type="text/javascript" src="<?= base_url('assets/js/master-min.js') ?>?v=<?= $version?>"></script>
